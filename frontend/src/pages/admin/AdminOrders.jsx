      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 bg-white p-8 rounded-3xl shadow-sm border border-slate-100">
        <div>
          <h2 className="text-2xl font-black text-slate-900 flex items-center">
            <ShoppingBag className="mr-3 text-primary" size={28} />
            Customer Orders
          </h2>
      ...
      <div className="bg-white rounded-3xl shadow-sm border border-slate-100 overflow-hidden">
        {loading ? (
          ...
          <div className="p-32 flex flex-col items-center justify-center text-center space-y-6">
            ...
            <div>
              <h3 className="text-xl font-black text-slate-900">Unable to load orders</h3>
          ...
          <div className="p-32 text-center">
            <div className="w-24 h-24 bg-slate-50 rounded-full flex items-center justify-center text-4xl mb-6 mx-auto">🛍️</div>
            <h3 className="text-xl font-black text-slate-900">No orders yet</h3>
            <p className="text-slate-500 mt-2">Customer orders will appear here once purchases are made.</p>
          </div>
        ) : (
